%simMinNormMeanDiff Simulate the Chip minimum normalized difference calculation
%
%  [minNormDiff heightToWidthRatio derivExtrema width sepStat] = ...
%    simMinNormMeanDiff(profile, FOV, nSmooth, diffStep, cThresh, badList)
%
% Status: functional
...
%%
minNormDiff = calcMinNormMeanDiff(hwrPerDevice);

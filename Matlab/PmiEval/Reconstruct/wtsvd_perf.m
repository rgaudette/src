%WTSVD_PERF
%
%  [WTrueErr, WResid, TrueErr, Resid] = wtsvd_perf(A, x, nSV, vSNR)
%
...
function [WTrueErr, WResid, TrueErr, Resid, TeClean, ResidClean] = wtsvd_perf(A, x, nSV, vSNR)
...
%%
%%  Precompute the economy SVD for the unweighted case
%%
[xhat_clean Uecon Secon Vecon] = fattsvd(A, b_true, nSV);
...
for iSNR = 1:nSNR
    ...
    %%
    [xhat] = fattsvd(A, b_noise, nSV, Uecon, Secon, Vecon);
    ...
    A_w = diag(w) * A;
    b_noise_w = w .* b_noise;
    [xhat_w] = fattsvd(A_w, b_noise_w, nSV);

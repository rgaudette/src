%SIGMA0    Derive sigma-0 for matched filter output and direct path power
%          level.
%
%    [Sigma0 Range NoiseFlr] = ...
%        sigma0(mfout, dRange, Azimuth, TxPos, DirPath, NoisePow)
%
%    Simga0    sigma-naught
%
...
%              (default: 0).
%
%        SIGMA0 derives the value of Sigma0 from the matched filter output
...
function [Sigma0, R2, NoiseFloor]  = sigma0(mfout, dRange, ...

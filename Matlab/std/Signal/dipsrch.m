%DIPSRCH        Simple algorithm to find the local minima of a vector.
%
%    [values index] = dipsrch(vector, flgEndPoints)
%
%    values     The values of the dips found.
%
%    index      The corresponding indices of each dip.
%
...
%                   neighbor.
%
%        DIPSRCH compares each interior element against it's nearest
%    neighbors, if it is less than both the point is considered a local
%    maxima.  If the optional parameter flgEndPoints is non-zero each
%    end point is also compared against it's sole neighbor.
%
%    Calls: none
%
%    Bugs:  If there is a local minima of 2 identically valued samples it
...
%  Matlab Source
%
%  Revision 1.1  1997/07/31 19:09:03  rjg
%  Initial revision
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [values, iLocalMax] = dipsrch(vector, flgEndPoints)

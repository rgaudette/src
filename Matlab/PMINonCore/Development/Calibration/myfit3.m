%MYFIT3         Compute the background properties of a PMI data structure
%
%   [mu_sp, mu_a] = myfit3(pmi, vInit, lstSrcGood, lstDetGood)
%
...
function [mu_sp, mu_a] = myfit3(pmi, vInit, lstSrcGood, lstDetGood)
nD = 16;
nS = 9;
...
for iMeas = 1:nMeas
    ...
    for iInit = 1:nInit
        ...
        temp = fmins('cali3', vInit(iInit, :), [], [], FF0, lstSrcGood, lstDetGood)

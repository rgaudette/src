%MSLICE_DK         Show multiple slices of a 3D volume in a dark background.
%
%   mslice_dk(X, CompVol, idxSlices, VisPlane, dimPlot, CAxis)
%
...
function mslice_dk(X, CompVol, idxSlices, VisPlane, dimPlot, CAxis)
colordef black
set(gcf, 'color', [0 0 0])

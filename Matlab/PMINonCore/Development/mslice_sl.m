%MSLICE_SL       Show multiple slices of a 3D volume for a slide.
%
%   mslice_sl(X, CompVol, idxSlices, VisPlane, dimPlot, CAxis)
%
...
%  $Author: rickg $
%
%  $Date: 2004/01/03 08:27:31 $
%
%  $Revision: 1.1.1.1 $
%
%  $Log: mslice_sl.m,v $
%  Revision 1.1.1.1  2004/01/03 08:27:31  rickg
%  Matlab Source
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function mslice_sl(X, CompVol, idxSlices, VisPlane, dimPlot, CAxis)
clf
colordef(gcf, 'black');
clf
colormap(ltbgyor(256))

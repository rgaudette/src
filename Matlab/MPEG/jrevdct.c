...
/* $Log: jrevdct.c,v $
/* Revision 1.1.1.1  2004/01/03 08:26:50  rickg
/* Matlab Source
/*
 * Revision 1.3  1994/01/14  15:48:26  daf
 * Added RCS info header
 *
 * revision 1.2    locked by: daf;
 * date: 1994/01/07 16:47:18;  author: daf;  state: Exp;  lines: +5 -11
 * Changed functions headers to ANSI C
 *
 * revision 1.1

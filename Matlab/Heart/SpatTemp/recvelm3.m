%RECVELM3       Recovery velocity estimate using fwd/bkwd Mallat's wavelets
%
%   [vel grad df_dt] = recvelm3(Data, szArray, Scales, idxStart,
%                                           pctThrsh, SaStep)
%
...
%  Matlab Source
%
%  Revision 1.1  1997/07/18 18:32:44  rjg
%  Initial revision
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [vel, grad, tdb, detT, detG, Tth, Gth] = ...
    recvelm3(Data, szArray, Scales, idxStart, pctThrsh, SaStep)
...
%%  values
%%
disp('Selecting appropriate differences...');
pos_td = tdb >= 0;
neg_td = ~pos_td;

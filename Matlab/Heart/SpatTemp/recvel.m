%RECVEL         Compute the recovery wavefront velocity
%
%  [velocity detT detG] = recvel(dv_dt, grad, idxStart, thresh_pct)
%
%   velocity    The computed velocity of the recovery wavefront.
%
...
%               spatial location.
%
%   RECVEL computes the velocity of the wavefront around the activation
...
%  Matlab Source
%
%  Revision 1.1  1997/06/26 18:22:14  rjg
%  Initial revision
%
%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [velocity, detT, detG] = recvel(dv_dt, grad, idxStart, thresh_pct)
...
TempThresh = max(dv_dt(:, idxStart:nSamples).').' * (thresh_pct / 100);

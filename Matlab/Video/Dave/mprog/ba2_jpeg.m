...
% performed on only the remaining subbands. The lowest
% subband is JPEG encoded for a further compression of 8:1. 
%
% author: David Hoag
%
...
function rec_img = bit_alloc2_JPEG(N,b);
...
% Set bit assignment of LL to 1 due to JPEG comp. 
bit_assign(1)=1;

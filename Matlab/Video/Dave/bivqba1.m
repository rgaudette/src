%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% For the 1st step in the biorthogonal decomposition, the 
% sample variances of the wavelet coefficients for each  
% subband are computed. Bits are then allocated to
...
function [rec_img, comp] = bi_vq_bit_alloc1(image,N,b);
...
% Reconstruct image
rec_img = bi_reconstN(quant_dwt_img,N);

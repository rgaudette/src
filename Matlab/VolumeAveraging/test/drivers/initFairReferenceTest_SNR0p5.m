...
save(mrcVolume, 'fairReferenceTest_SNR0p5.mrc');
save(MRCImage(fullRef), 'fairReferenceTest_InitRef_SNR0p5.mrc');
write(modParticle, 'fairReference_True_SNR0p5.mod');
tom_emwrite('fairReferenceTest_SNR0p5_MOTL_1.em', tom_emheader(motiveList));
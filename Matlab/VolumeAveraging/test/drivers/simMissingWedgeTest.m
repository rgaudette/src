...
write(modParticle, 'missingWedgeTest.mod');
...
tom_emwrite('missingWedgeTest_MOTL.em', tom_emheader(motl));

outMotl = particleAlign3(mrcVolume, 2, modParticle, szFullRef, motl, ...
  [-10:10:10], [-10:10:10], [-0:10:10], shiftLimit, 0, 0.866, 2);

shiftDiff = outMotl(11:13, :)' - offset
avgVol = ...
  motlAverage3mw(mrcVolume, modParticle, szFullRef, outMotl, 0, tiltRange);

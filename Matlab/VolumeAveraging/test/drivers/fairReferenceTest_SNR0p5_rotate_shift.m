volume = MRCImage('fairReferenceTest_SNR0p5.mrc', 0);
imodParticle = ImodModel('fairReference_True_SNR0p5.mod');
searchRadius = 10;
...
motiveList = loadMOTL('fairReferenceTest_SNR0p5_MOTL_1.em')
szVol = [36 36 36]
vDeltaPhi = [-20:10:20]
...
save fairReferenceTest_SNR0p5_rotate_shift_wideband ...

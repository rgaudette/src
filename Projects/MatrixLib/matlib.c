...
//
//  Description:
//      MatrixLib is a class library containing a number of routines for
//  use with matices.  The matrix class is defined in MatrixLib.h
//
//		Portions of this library are originaly derived the C library MATLIB.
#include <stdio.h>
#include <stdlib.h>
#include "matlib.h"

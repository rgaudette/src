...
#############################################################################
# pythonqt_test - PyQT application template for KDevelop
#
...
class pythonqt_test(QMainWindow):
    """An application called pythonqt_test."""

    def __init__(self):
        QMainWindow.__init__(self, None, "pythonqt_test")
        self.initIcons()
        self.setup()
        self.initPrinter()
        self.initToolBar()
    ...
    def setup(self):
        ...
        self.appTitle = "pythonqt_test - PyQT Application Example"

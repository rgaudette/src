...
**
**  -[i|w] IntialCB  The initial codebook filename.  If the -i option is given
**                   the initial codebook is readin from the specified MATLAB
**                   file.  If -i is not present the initial codebook is
**                   generated by performing the LBG algorithm upon random data
**                   extracted from the end of the traning data variable.  If -w
**                   is given the initial codebook is written out to the geven
**                   file.  The variable name in either case is VQ.
**
...
**
**  -b Start         The initial codebook rate to generate, in bits/sample.
**
**  -k nCodes        The codes in the intial codebook.
**
**  -n nElem         The number of elements in each vector of the codebook.
**
**  -r nBooks        The codebooks (and hence the number of rates) to generate.
**
**  -s Step          The step size for the codebook rates.
**
**
**  Output Paramters
**
...
**
**  $Log: ecvq.c,v $
**  Revision 1.4  1996/03/20 01:52:24  root
...
int main(int argc, char *argv[]) {
    ...
    if (flgLoadInitCB) {
         ...
         **/
        fprintf(stderr, "Loading in the initial codebook from %s\n",
                InitCBFile);
         ...
         **/
        fprintf(stderr, "Initial codebook generated from training data\n");
    ...
    /**
     **  Allocate the entropy and sample PMF vectors
     **/
    ...
    if(flgSaveInitCB) {
         ...
         **/
        fprintf(stderr, "Saving intial codebook to  %s\n", InitCBFile);
...
void Usage() {
fprintf(stderr, "\nProgram:  ecvq\n\n");
fprintf(stderr,"Usage:  ecvq <Parameters>\n\n");
fprintf(stderr,"\n");
fprintf(stderr,"Training Data Parameters\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -[i|w] IntialCB  The initial codebook filename.  If the -i option is given\n");
fprintf(stderr,"                   the initial codebook is readin from the specified MATLAB\n");
fprintf(stderr,"                   file.  If -i is not present the initial codebook is\n");
fprintf(stderr,"                   generated by performing the LBG algorithm upon random data\n");
fprintf(stderr,"                   extracted from the end of the traning data variable.  If -w\n");
fprintf(stderr,"                   is given the initial codebook is written out to the geven\n");
fprintf(stderr,"                   file.  The variable name in either case is VQ.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -N nVecs         The number of training vectors to use.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -t Training      The training data filename.  This should be a MATLAB format\n");
fprintf(stderr,"                   format file containing the variable named by the -v option\n");
fprintf(stderr,"                   below.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -v Variable      The training data variable.  A MATLAB variable structure\n");
fprintf(stderr,"                   within the MATLAB file described above.  This should be a\n");
fprintf(stderr,"                   Nx1 matrix of random distributed according to the codebook\n");
fprintf(stderr,"                   requirements.\n");
fprintf(stderr,"\n");
fprintf(stderr,"Codebook Rate Parameters\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -b Start         The initial codebook rate to generate, in bits/sample.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -k nCodes        The codes in the intial codebook.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -n nElem         The number of elements in each vector of the codebook.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -r nBooks        The codebooks (and hence the number of rates) to generate.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -s Step          The step size for the codebook rates.\n");
fprintf(stderr,"\n");
fprintf(stderr,"\n");
fprintf(stderr,"Output Paramters\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -d rdfile        The rate-distortion table file to create.\n");
fprintf(stderr,"\n");
fprintf(stderr,"  -f base          The basename of the codebooks.  The filename of the \n");
fprintf(stderr,"                   codebooks will be generated as baseeDDD.mat where DDD\n");
fprintf(stderr,"                   is the index of the codebook.  The variable name VQ within\n");
fprintf(stderr,"                   the file contains the codebook.\n");
fprintf(stderr,"\n");
}

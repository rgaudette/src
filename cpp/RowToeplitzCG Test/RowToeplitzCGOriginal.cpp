...
RowToeplitzCGOriginal::
RowToeplitzCGOriginal(int nrm, int nim, int n_restart) :
  n_rows_max(nrm),
  n_impulse_max(nim),
  n_restart(n_restart)
{
...
int RowToeplitzCGOriginal::solve_normal_eq(const float * row,
                                           int n_row_elements,
                                           int n_rows,
                                           const float * b,
                                           float * est_x,
...
void RowToeplitzCGOriginal::updateResidual(const float * row,
                                           int n_row_elements,
                                           int n_rows,
                                           float * est_x,
                                           int n_cols,
